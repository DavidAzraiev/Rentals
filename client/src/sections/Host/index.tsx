...
export const Host = ({ viewer }: Props) => {
  ...
  >(HOST_LISTING, {
    onCompleted: () => {
      displaySuccessNotification("You're successfully created your listing!");
    },
    onError: () => {
      displayErrorMessage(
      ...
      <Content className='host-content'>
        <div className='host__form-header'>
          <Title level={4} className='host__form-title'>
            You'll have to be signed in and connect with Stripe to host a
            listing!
          </Title>
          <Text type='secondary'>
            ...
            <Link to='/login'>Login Page</Link> and connect with stripe shortly
            after.
          </Text>
        </div>
      </Content>
    ...
    return (
      <Content className='host-content'>
        <div className='host__form-header'>
          ...
          <Text type='secondary'>We are creating you're listing now.</Text>
        </div>
      </Content>
    );
  }
    ...
    <Content className='host-content'>
      <Form layout='vertical' onFinish={handleHostListing}>
        ...
        >
          <Input
            maxLength={45}
            placeholder='The iconic and luxurious Tel Aviv'
          />
        </Item>
        <Item
        ...
        >
          <Input.TextArea
            rows={3}
            maxLength={400}
            placeholder="Tel Aviv is Israel's cultural and commercial capital. “The city which never sleeps” is a center for nightlife, cuisine, culture, and liberalism."
          />
        </Item>
        <Item
          label='Address'
        ...
        >
          <Input placeholder='HaYarkon St 100' />
        </Item>
        <Item
          label='City/Town'
          name='city'
        ...
        >
          <Input placeholder='Tel Aviv-Yafo' />
        </Item>
        <Item
        ...
        <Item
          label='Image'
          extra='Images have have to be under 1MB in size and of type JPG or PNG'
          name='image'
          rules={[
            {
              required: true,
